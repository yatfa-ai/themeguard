...
describe("the manifest, before anything is packed", () => {
  it("is version 0.1.4 — 0.1.3 gave three rules a position; 0.1.4 binds a suppression to its site", () => {
...
describe("publication readiness", () => {
   ...
   */
  it("passes `npm publish --dry-run` and reports the 0.1.4 tarball", () => {
    ...
    expect(combined).toContain("themeguard@0.1.4");
  }, 300_000);
});
